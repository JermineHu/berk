...
func (i *FloatType) GetFloat() float32 {
	if i == nil {
		return 0
	}
	return i.Float
...
func Float(i float32) *FloatType {
	return &FloatType{Float: i, Null: false}
}

func (n *FloatType) Scan(value interface{}) error {
	v := sql.NullFloat64{Float64: float64(n.Float), Valid: !n.Null}
	if err := v.Scan(value); err != nil {
		return err
	}

	n.Null = !v.Valid
	n.Float = float32(v.Float64)
	return nil
}
...
func (i FloatType) MarshalJSON() ([]byte, error) {
	...
	return []byte(strconv.FormatFloat(float64(i.Float), 'f', 2, 32)), nil
}
...
// It supports number and null input.
// 0 will not be considered a null Int.
func (i *FloatType) UnmarshalJSON(data []byte) error {
	var err error
	var v interface{}
	if err = json.Unmarshal(data, &v); err != nil {
		return err
	...
	case float64:
		// Unmarshal again, directly to int64, to avoid intermediate float64
		err = json.Unmarshal(data, &i.Float)
	case nil:
		i.Null = true
		return nil
	default:
...
func (i *FloatType) UnmarshalText(text []byte) error {
	str := string(text)
	if str == "" || str == "null" {
		i.Null = true
		return nil
