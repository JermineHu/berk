...
//Filter
var (
	FilterNotFoundErr       = NewMeanError("Filter not found", 8000, 403, ErrorTypePublic)
	PreferFilterOutLimitErr = NewMeanError("prefer filter out of limit", 8001, 403, ErrorTypePublic)
)
