...
func (i *ImagePipeline) Put(callbackUrl, PFOP_URL string) (string, error) {
	s := "bucket=" + i.fileManager.GetBucketName() + "&key=" + i.originKey + "&fops=" + i.persistentOps + "&notifyURL=" + c.CallbackDomain + callbackUrl + "&pipeline=tuso_pipeline"
